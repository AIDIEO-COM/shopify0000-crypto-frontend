    ...
    const fetchCryptoData = async () => {
      try {
        const response = await fetch(
          "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=solana,bonk,dogwifhat,popcat,maga,bitcoin&order=market_cap_desc&per_page=5&page=1&sparkline=false&x_cg_demo_api_key=CG-DCsQ1aXvDPbf5J2Nxce8W6mW"
        );
