...
const CodeVerification = () => {
  ...
  const [isLoadingFreeTrial, setIsLoadingFreeTrial] = useState(false);
  ...
  const onClickAction = () => {
    // show loder in this button
    setIsLoadingFreeTrial(true);
    setTimeout(() => {
      setIsLoadingFreeTrial(false);
      navigate('/dashboard')
    }, 2000);
  }
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg bg-white/5 border ${error ? "border-red-400 " : "border-purple-400/50"
                } text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 ${error ? "focus:ring-red-400" : "focus:ring-purple-400"
                } transition-all`}
              required
              value={code}
