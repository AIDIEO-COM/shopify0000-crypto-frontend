              ...
              {isConnectWallet ? (
                <div className="space-y-2 mb-4">
                  ...
                  <button
                    ...
                    className="px-4 mt-2 cursor-pointer py-2 bg-blue-600 text-white rounded-xl"
                  >
                    Withdraw Funds
                  </button>
                </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center gap-5 mt-2">
                    <button
                      className={`px-6 py-2 cursor-pointer rounded-xl ${
                        gasFee === "normal" ? "bg-blue-600" : "bg-gray-500"
                      } text-white`}
                    ...
                    <button
                      className={`px-6 py-2 cursor-pointer rounded-xl ${
                        gasFee === "fast" ? "bg-blue-600" : "bg-gray-500"
                      } text-white`}
